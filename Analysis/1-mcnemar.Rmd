...
First, we define our significance level (alpha). 

create the 2x2 contingency table representing paired nominal data (e.g., pre-test vs. post-test results).
...
contingency_table <- matrix(c(20, 15, 5, 10), nrow = 2, byrow = TRUE, dimnames = list(Pre = c("Yes","No"), Post = c("Yes","No")))

print(contingency_table)

result_base <- mcnemar.test(contingency_table)
print(result_base)
